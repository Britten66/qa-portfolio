...
- Name: app-under-test/api/smoke.spec.js >> Edge function smoke tests >> voice parse is alive and requires auth
- Location: apps/app-under-test/api/smoke.spec.js:35:3
...
Call log:
  - → OPTIONS https://api.example.com/functions/v1/voice-parse
