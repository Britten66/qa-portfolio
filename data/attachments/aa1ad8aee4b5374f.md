...
- Name: invoiceprepper/e2e/accessibility.spec.js >> Accessibility: WCAG + best practice >> sign up modal has no violations
- Location: apps/invoiceprepper/e2e/accessibility.spec.js:78:3
...
- generic [ref=e2]:
  ...
  - dialog "Create your account" [ref=e371]:
    - button "← Back" [ref=e372] [cursor=pointer]
    - generic [ref=e373]: InvoicePrepper
    - generic [ref=e374]: Create your account
    - generic [ref=e375]:
    ...
    - generic [ref=e386]:
      ...
      - generic [ref=e390]:
        ...
        - textbox "Password" [ref=e392]:
          - /placeholder: ••••••••
      - generic [ref=e393]:
        - generic [ref=e394]: Confirm Password
        - textbox "Confirm Password" [ref=e395]:
          - /placeholder: ••••••••
      - generic [ref=e396]:
        - generic [ref=e397]: Referral code (optional)
        - textbox "Referral code (optional)" [ref=e398]:
          - /placeholder: ABC23XYZ
      - button "Create Account" [ref=e399] [cursor=pointer]
```
