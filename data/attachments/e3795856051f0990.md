...
- Name: app-under-test/api/smoke.spec.js >> Edge function smoke tests >> subscription status is alive and requires auth
- Location: apps/app-under-test/api/smoke.spec.js:58:3
...
Call log:
  - → OPTIONS https://api.example.com/functions/v1/subscription-status
