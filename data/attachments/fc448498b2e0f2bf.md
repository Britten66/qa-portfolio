...
- Name: app-under-test/e2e/auth.spec.js >> Auth modal: Forgot password >> shows reset form with Send Reset Link button
- Location: apps/app-under-test/e2e/auth.spec.js:99:3
