...
- Name: app-under-test/api/smoke.spec.js >> Edge function smoke tests >> records function is alive and requires auth
- Location: apps/app-under-test/api/smoke.spec.js:29:3
...
Call log:
  - → OPTIONS https://api.example.com/functions/v1/receipts
